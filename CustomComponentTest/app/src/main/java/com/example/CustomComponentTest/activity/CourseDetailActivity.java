...
import com.example.CustomComponentTest.adapter.CourseCommentAdapter;
...
import com.example.CustomComponentTest.view.course.CourseDetailFooterView;
import com.example.CustomComponentTest.view.course.CourseDetailHeaderView;
...
public class CourseDetailActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    * */
    ...
    protected void onNewIntent(Intent intent) {
        ...
        setIntent(intent);//更新当前页面的intent
        initData();
        initView();
        requestDeatil();
    }
